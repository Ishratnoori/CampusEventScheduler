...
class Admin:
    def __init__(self, root):
        ...
        self.student__login = Label(self.right,text="1.ISTE",bg='White',fg='Black')
        self.student__login.place(x=170,y=50)
        self.admin_logout_btn = Button(self.right, text = 'LOGOUT', font = fonts,command = self.admin_logout)
        self.admin_logout_btn.place(x = 300, y = 250)
...
class Student:
    def __init__(self, root):
        ...
        self.student_logout_btn = Button(self.left, text = 'LOGOUT', font = fonts,command = self.Student_logout)
        self.student_logout_btn.place(x = 300, y = 250)
